...
searchPrompt = userLikes + " The user inputted the following for their ideas: " + userPreference + "\n Can you give suggestions near " + location + " ? Return a json string where each suggestion has the following format that I can turn into python, only return the json string as answer, and the id is the number of the response: {ID: int; Place: string; City: string; Description: string; Distance: number; Price: (range from $ to $$$$); Resources/Links: string} "
